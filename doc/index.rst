...
.. table:: Geodynamic modules and Subtopics
    ...
    +-----------------------------+-------------------------------------------------------------+
    | Shortening, orogenesis, &   | - Upper plate deformation (mountains vs. back-arcs)         |
    | subduction                  | - Subduction zone forces (e.g., slab pull, ridge push)      |
    |                             | - Subduction-induced mantle flow (e.g., toroidal vs         |
    |                             |   poloidal)                                                 |
